...
export default constants = {
  ...
  VERSION: JSON.parse(FileLib.read("BetterColeweight", "metadata.json"))
    .version,
  CWINFO: undefined,
  data: PogData,
  beta: false,
...
register("gameLoad", () => {
  axios
    .get("https://ninjune.dev/api/cwinfo?new=true")
    .then((res) => {
...
register("chat", (message, pet, event) => {
  if (message == "summoned") constants.data.currentPet = pet.toLowerCase();
  else if (message == "despawned") constants.data.currentPet = "N/A";

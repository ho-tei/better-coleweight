...
export function openCoordsGui()
{
    ...
    const CoordsGui = new JavaAdapter(WindowScreen, {
        init() {
            ...
            coordsWindow(2, 2, "Automatons", "bcw automatons toggle", "https://i.imgur.com/i4V5tzU.png", true, "Sit in pot somewhere (check image in command) (image isn't loading)").setChildOf(this.getWindow())
